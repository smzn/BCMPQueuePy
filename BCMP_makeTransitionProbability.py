...
class TransitionProbabilityCalculator:
    ...
    def get_transition_probability(self):
        ...
        # (7) Save data
        dirname = f'N{self.N}_R{self.R}_K{self.K_total}_U{self.U}_X{self.max_distance_x}_Y{self.max_distance_y}'
...
#python BCMP_makeTransitionProbability.py N R U[max_distance_x] [max_distance_y]
#python BCMP_makeTransitionProbability.py 33 2 3 500 500