...
class BCMP_MVA_Computation:
    ...
    def __init__(self, N, R, K, mu, m, K_total, max_x, max_y, tp, pid, rank, size, comm, output_dir):
        self.N = N
        self.R = R
        self.K = K
...
if __name__ == '__main__':
    ...
    bcmp = BCMP_MVA_Computation(N, R, K, mu, m, K_total, max_x, max_y, p, pid, rank, size, comm, output_dir)
    start = time.time()
    L = bcmp.getMVA()
    ...
    #mpiexec -n 8 python BCMP_MVA_ParallelComputation.py 10 2 50 3
