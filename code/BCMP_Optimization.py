...
if __name__ == '__main__':
    ...
    if rank == 0:
        output_dir = time.strftime(f"../results/Optimization_N{N}_R{R}_K{K_total}_U{U}_X{max_x}_Y{max_y}_algorithm{'MVA' if algorithm == 1 else 'Simulation'}_Size{size:02}_%Y%m%d%H%M%S")
    ...
    #mpiexec -n 8 python BCMP_Optimization.py 10 2 50 3 500 500 8 20 0.5 0.2 1 2 1000
